...
separate UK national standard. The 121-jurisdiction research footprint includes access-blocked
...
`tools/build_coverage.py`. Current totals: 295 distinct fixed profiles in 18 countries,
121 research jurisdictions, 214 source records, and 470 country-profile assignments;
the default table of 122 includes one legacy-only template country (BE).
