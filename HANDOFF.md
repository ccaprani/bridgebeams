...
`tools/build_coverage.py`. Current totals: 301 distinct fixed profiles in 18 countries,
122 research jurisdictions, 233 source records, and 476 country-profile assignments;
