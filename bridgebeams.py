...
# -*- coding: utf-8 -*-
"""
bridgebeams is a module that uses the wonderul sectionproperties package to
provide section properties for standard Australian Bridge Beams to AS5100.5

@author: Colin Caprani, Monash University
"""
