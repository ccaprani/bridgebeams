...
def test_standard_depth_matches_published_table():
...
def test_safe_side_selection_between_standard_lengths():
...
def test_web_rule_matches_published():
...
def test_all_45_depths_construct_and_valid():
    count = 0
